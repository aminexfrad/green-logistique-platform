...
import { mockCarbonProjects } from '@/lib/mock-data'
...
export default function CarbonMarketplace() {
  ...
  const cartItems = Object.entries(cart).map(([projectId, qty]) => ({
    project: mockCarbonProjects.find((p) => p.id === projectId)!,
    qty,
  }))
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Purchase carbon credits to offset your shipment emissions
            </p>
          </div>
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {item.qty} ton(s) × ${item.project.pricePerTon}
                          </p>
                        </div>
                        <p className="font-bold text-primary">
                          ${(item.qty * item.project.pricePerTon).toFixed(2)}
                        </p>
                      </div>
                    ))}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {mockCarbonProjects.map((project, idx) => (
              <motion.div
                key={project.id}
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="text-xs">
                        ...
                        <span className="font-semibold text-primary">
                          {project.co2TonsAvailable.toLocaleString()} tons
                        </span>
                      </div>
                      <div className="text-xs">
        ...
        {/* Compensated Shipments */}
        <div className="rounded-xl border border-border bg-card p-6">
          <h3 className="text-lg font-bold text-foreground mb-4">
            Recently Compensated Shipments
          </h3>
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Compensated 50 tons CO2 via Reforestation
                  </p>
                </div>
